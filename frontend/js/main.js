$(function () {
  ...
  /***************************
    Fix for form submission after page load
    ***************************/
  // Ensure Swup doesn't interfere with form submission
  document.addEventListener("swup:contentReplaced", function () {
    // Re-bind the form submission logic after content is replaced
...
// JavaScript function to toggle between Contact and Appointment fields
function toggleFormType() {
  const formType = document.getElementById("form_type").value;
  const appointmentFields = document.getElementById("appointment_fields");
